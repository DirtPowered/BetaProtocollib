...
import com.github.dirtpowered.betaprotocollib.packet.Version_B1_9.data.V1_9WindowClickPacketData;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;

public class WindowClickPacket extends AbstractPacket<V1_9WindowClickPacketData> {
    ...
    @Override
    public ByteBuf writePacketData(V1_9WindowClickPacketData packet) {
    ...
    @Override
    public V1_9WindowClickPacketData readPacketData(ByteBuf buffer) {
        ...
        return new V1_9WindowClickPacketData(windowId, inventorySlot, mouseClick, action, readItemStack(buffer, itemId, ItemStackType.ITEM_B1_9), shiftPressed);
    }
}
