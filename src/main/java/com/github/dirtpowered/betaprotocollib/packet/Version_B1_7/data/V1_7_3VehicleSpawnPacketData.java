...
public class V1_7_3VehicleSpawnPacketData extends Packet<VehicleSpawnPacket> {
    ...
    public V1_7_3VehicleSpawnPacketData(int entityId, int type, int x, int y, int z, int throwerEntityId, int velocityX, int velocityY, int velocityZ) {
    ...
    public String toString() {
        return "V1_7_3VehicleSpawnPacketData{"
                + "entityId=" + entityId
                + ", type=" + type
                + ", x=" + x
                + ", y=" + y
