...
public class SleepPacket extends AbstractPacket<SleepPacketData> {
    ...
    @Override
    public ByteBuf writePacketData(SleepPacketData packet) {
    ...
    @Override
    public SleepPacketData readPacketData(ByteBuf buffer) {
        int entityId = buffer.readInt();
        boolean wakeup = buffer.readBoolean();
        int x = buffer.readInt();
        int y = buffer.readByte();
        int z = buffer.readInt();
        return new SleepPacketData(entityId, wakeup, x, y, z);
    }
}
