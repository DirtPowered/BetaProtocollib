...
public class V1_7_3MobSpawnPacketData extends Packet<MobSpawnPacket> {
    ...
    public V1_7_3MobSpawnPacketData(int entityId, byte type, int x, int y, int z, byte yaw, byte pitch, List<WatchableObject> metadata) {
    ...
    public String toString() {
        return "V1_7_3MobSpawnPacketData{"
                + "entityId=" + entityId
                + ", type=" + type
                + ", x=" + x
                + ", y=" + y
