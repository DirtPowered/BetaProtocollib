...
import com.github.dirtpowered.betaprotocollib.packet.Version_R1_3.data.V1_3MapChunkPacketData;
...
public class MapChunkPacket extends AbstractPacket<V1_3MapChunkPacketData> {
    ...
    @Override
    public ByteBuf writePacketData(V1_3MapChunkPacketData packet) {
    ...
    @Override
    public V1_3MapChunkPacketData readPacketData(ByteBuf buffer) throws IOException {
        ...
        return new V1_3MapChunkPacketData(chunkX, chunkZ, groundUp, primaryBitmap, additionalBitmap, compressedDataSize, chunk);
    }
}
