...
public class V1_7_3WindowClickPacketData extends Packet<WindowClickPacket> {
    ...
    public V1_7_3WindowClickPacketData(int windowId, int inventorySlot, int mouseClick, short action, BetaItemStack betaItemStack, boolean shiftPressed) {
    ...
    public String toString() {
        return "V1_7_3WindowClickPacketData{"
                + "windowId=" + windowId
